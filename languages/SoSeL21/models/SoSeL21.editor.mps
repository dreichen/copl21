...
<model ref="r:fb00adde-e008-41db-87ff-8075062c57f8(SoSeL21.editor)">
  ...
  <node concept="24kQdi" id="2cuvxf1MCp3">
    ...
    <node concept="3EZMnI" id="2cuvxf1MJu7" role="2wV5jI">
      <node concept="2iRfu4" id="2cuvxf1MJu8" role="2iSdaV" />
      <node concept="1iCGBv" id="2cuvxf1NuF1" role="3EZMnx">
        <ref role="1NtTu8" to="v8ga:2cuvxf1NuEI" resolve="left" />
        <node concept="1sVBvm" id="2cuvxf1NuF3" role="1sWHZn">
          <node concept="3F0A7n" id="2cuvxf1NuFc" role="2wV5jI">
            <property role="1Intyy" value="true" />
            <ref role="1NtTu8" to="tpck:h0TrG11" resolve="name" />
          </node>
        </node>
      </node>
      <node concept="PMmxH" id="2cuvxf1MJug" role="3EZMnx">
        <ref role="PMmxG" to="tpco:2wZex4PafBj" resolve="alias" />
      </node>
      <node concept="1iCGBv" id="2cuvxf1NuFp" role="3EZMnx">
        <ref role="1NtTu8" to="v8ga:2cuvxf1NuEK" resolve="right" />
        <node concept="1sVBvm" id="2cuvxf1NuFr" role="1sWHZn">
          <node concept="3F0A7n" id="2cuvxf1NuFA" role="2wV5jI">
            <property role="1Intyy" value="true" />
            <ref role="1NtTu8" to="tpck:h0TrG11" resolve="name" />
          </node>
        </node>
      </node>
      <node concept="3F0ifn" id="2cuvxf1NAiZ" role="3EZMnx">
        <property role="3F0ifm" value=";" />
      </node>
    </node>
  </node>
